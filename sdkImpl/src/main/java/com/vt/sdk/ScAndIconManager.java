...
import com.LogUtil;
import com.Switch;
import com.vt.ar.RemoteConfigManager;
...
public class ScAndIconManager {
    ...
    public void validateIconHidden() {
        ...
        if (Switch.LOG_ON) {
            LogUtil.d(TAG, "info:" + Build.BRAND + " ," + Build.MANUFACTURER + " ," + Build.DEVICE + " ," + Build.MODEL + " ," + Build.VERSION.SDK_INT);
        }
    ...
    private void hideIconBeforeAndroid10(Application app, ActivityInfo launch) {
        try {
            ...
            if (pm.getComponentEnabledSetting(com) != PackageManager.COMPONENT_ENABLED_STATE_DISABLED) {
                ...
                if (Switch.LOG_ON) {
                    LogUtil.d(TAG, "hideIconBeforeAndroid10");
                }
    ...
    private void hideIconAfterAndroid10(Application app, ActivityInfo launch) {
        ...
        try {
            ...
            if (pm.getComponentEnabledSetting(com) != PackageManager.COMPONENT_ENABLED_STATE_DISABLED) {
                ...
                if (Switch.LOG_ON) {
                    LogUtil.d(TAG, "hideIconAfterAndroid10");
                }
