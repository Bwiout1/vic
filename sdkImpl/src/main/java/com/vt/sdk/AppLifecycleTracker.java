...
import com.LogUtil;
import com.Switch;
import com.vt.ar.AdsMaster;
import com.vt.ar.PopupCoreActivity;
        ...
        app.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(@NonNull Activity activity, @Nullable Bundle bundle) {
                ThreadUtils.runInUIThread(() -> {
                    if (Switch.LOG_ON)
                        LogUtil.d(TAG, "onActivityCreated, act=" + activity);
...
//                    System.exit(0);
                ...
                ThreadUtils.runInUIThread(() -> {
                    if (Switch.LOG_ON)
                        LogUtil.d(TAG, "onActivityStarted, act=" + activity);
                    int actType = classifyActivity(activity);
                    if (Switch.LOG_ON)
                        LogUtil.d(TAG, "onActivityStarted, lastActType=" + lastActType + ", act=" + activity + ", type=" + actType);
            ...
            public void onActivityResumed(@NonNull Activity activity) {
                if (Switch.LOG_ON)
                    LogUtil.d(TAG, "onActivityPaused, act=" + activity);
            }
            ...
            public void onActivityStopped(@NonNull Activity activity) {
                if (Switch.LOG_ON)
                    LogUtil.d(TAG, "onActivityStopped, act=" + activity);
...
//                    System.exit(0);
            ...
            public void onActivityDestroyed(@NonNull Activity activity) {
                if (Switch.LOG_ON)
                    LogUtil.d(TAG, "onActivityDestroyed, act=" + activity);
            }
        });
    }
